...
package com.xuexiang.qqgg.adapter.base.delegate;
...
public class XYMarkerView extends MarkerView {
    ...
    public void refreshContent(Entry e, Highlight highlight) {
        tvContent.setText(String.format("月份: %s, 金额: %s", xAxisValueFormatter.getFormattedValue(e.getX()), yAxisValueFormatter.getFormattedValue(e.getY())));
